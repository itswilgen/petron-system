...
<header class="bg-white py-4 px-4 md:px-8 shadow-sm flex justify-between items-center">
    <div>
        ...
        <p class="text-sm text-gray-500 font-medium">Live branch-by-branch operations monitor</p>
    </div>
...
<script src="/public/assets/js/branch_operations.js?v=<?= filemtime(__DIR__ . '/../../assets/js/branch_operations.js') ?>"></script>
