...
<script src="/public/assets/vendor/chartjs/chart.umd.min.js?v=<?= filemtime(__DIR__ . '/../../assets/vendor/chartjs/chart.umd.min.js') ?>"></script>
<script src="/public/assets/js/reports_staff.js"></script>
