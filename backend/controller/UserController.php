...
class UserController {
    ...
    private function redirectDenied() {
        header("Location: /public/admin/app.php?page=staff_manage&denied=1");
        exit;
    }
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            if ($user_data) {
                ...
                if ($_SESSION['role'] === ROLE_SUPER_ADMIN) {
                    header("Location: /public/superadmin/app.php?page=dashboard");
                    exit;
                }

                if (canAccessAdminArea($_SESSION['role'])) {
                    header("Location: /public/admin/app.php?page=dashboard");
                    exit;
                }

                if (canAccessStaffArea($_SESSION['role'])) {
                    header("Location: /public/staff/app.php?page=dashboard");
                    exit;
                }
    ...
    public function createStaff() {
        ...
        if (($created['ok'] ?? false) === true) {
            ...
            header("Location: /public/admin/app.php?page=staff_manage&{$query}");
            exit;
        }
    ...
    public function deleteStaff() {
        ...
        header("Location: /public/admin/app.php?page=staff_manage&deleted=1");
        exit;
    }
